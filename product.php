...
?>
                      <tr>
                        ...
                        <td>
				<a href="#updateordinance<?php echo $row['medicine_id'];?>" data-target="#updateordinance<?php echo $row['medicine_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a>
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['serial'];?>" required>  
				...
				<div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['medicine_id'];?>" required>  
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="medicine_desc" value="<?php echo $row['medicine_desc'];?>" required>  
					...
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="supplier" required>
					      ...
					      <?php
							...
							$query2=mysqli_query($con,"select * from user")or die(mysqli_error());
							  while($row2=mysqli_fetch_array($query2)){
					      ?>
							    <option value="<?php echo $row['user_id'];?>"><?php echo $row2['name'];?></option>
					      <?php }?>
					    </select>
					</div>
				</div> 
              ...
              <option value="<?php echo $row['cat_id'];?>"><?php echo $row['medicine_cat'];?></option>
                <?php
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
              <label class="control-label col-lg-3" >Medicine Category</label>
              <div class="col-lg-9">
                <select class="form-control select2" style="width: 100%;" name="medicine_cat" required>
