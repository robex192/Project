                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title">View medicine Product Details</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post" action="product_update.php" enctype='multipart/form-data'>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['serial']; ?>" disabled>  
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="name">Medicine Name</label>
                                                                        <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="medicine_id" value="<?php echo $row['medicine_id']; ?>" disabled>  
                                                                            <input type="text" class="form-control" id="name" name="medicine_name" value="<?php echo $row['medicine_name']; ?>" disabled>  
                                                                        </div>
                                                                    </div> 
                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="name">Description</label>
                                                                        <div class="col-lg-9">
                                                                            <input type="text" class="form-control" id="name" name="medicine_desc" value="<?php echo $row['medicine_desc']; ?>" disabled>  
                                                                        </div>
                                                                    </div> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" class="form-control" id="price" name="medicine_price" value="<?php echo $row['medicine_price']; ?>" disabled>  
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="number" class="form-control" id="price" name="reorder" value="<?php echo $row['reorder']; ?>" disabled>  
                                                                        </div>
                                                                    </div>
                                                                      <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="price">Medicine Qty</label>
                                                                        <div class="col-lg-9">
                                                                            <input type="number" class="form-control" id="price" name="medicine_qty" value="<?php echo $row['medicine_qty']; ?>" disabled>  
                                                                        </div>
                                                                    </div> 
                                                             <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="price">Medicine Category</label>
                                                                        <div class="col-lg-9">
                                                                            <input type="number" class="form-control" id="price" name="cat_id" value="<?php echo $row['cat_id']; ?>" disabled>  
                                                                        </div>
                                                                    </div>
