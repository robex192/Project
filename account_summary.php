...
<html>
  <head>
    ...
    <title>Customer Account | <?php include('../asset/includes/title.php');?></title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="container">
		  ...
		  ?>	
		    <img class = "profile_pic" src = "../asset/uploads/<?php echo $row['cust_pic'];?>">
...
?>
                      <tr>
                        ...
                        <td><?php echo $row1['medicine_price'];?></td>
...
?>
                      <tr>
                        ...
                        <td><?php echo $row3['medicine_name'];?></td>
