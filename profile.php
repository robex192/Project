      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><a href="home_stock_manager.php"><i class="fa fa-dashboard"></i> Home</a></li>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" value="<?php echo $row['user_name'];?>" name="user_name" placeholder="Full Name" >
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <div class="form-group">
