...
<html>
  <head>
    ...
    <title>Account Details | <?php include('../asset/includes/title.php');?></title>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" value="<?php echo $row['user_name'];?>" name="user_name" placeholder="Full Name" Disabled>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <div class="form-group">
                    <label for="date">User Role</label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" value="<?php echo $row['user_role'];?>" name="user_role" placeholder="Username" Disabled>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input class = "btn btn-twitter" type="submit" value="Submit">
