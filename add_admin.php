...
include 'dbcon.php';
	...
	$pass1=$salt.$pass1;
		...
		(user_role,user_email,user_dob,user_address,gender,phone_num,password,user_name,status) 
		VALUES
		('$username','$user_email','$user_dob','$user_address','$gender','$phone_num','$pass1','$name','$status')")
