...
<html>
    <head>
        ...
        <title>Supplier | <?php include('../asset/includes/title.php'); ?></title>
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "select * from organization")or die(mysqli_error());
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $row['organ_name']; ?></td>
                                                        <td><?php echo $row['organ_address']; ?></td>
                                                        <td><?php echo $row['organ_contact']; ?></td>


                                                        <td>

                                                            <a href="#updateordinance<?php echo $row['organ_id']; ?>" data-target="#updateordinance<?php echo $row['organ_id']; ?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a>

                                                        </td>
                                                    </tr>
                                                <div id="updateordinance<?php echo $row['organ_id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
