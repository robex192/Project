                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php 
                      $query=mysqli_query($con,"select COUNT(*) as count from product where medicine_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>	
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select medicine_name from product where medicine_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
			  while($rowprod=mysqli_fetch_array($queryprod)){
			?>
                          <li><!-- start notification -->
                            <a href="reorder.php">
                              <i class="glyphicon glyphicon-refresh text-red"></i> <?php echo $rowprod['medicine_name'];?>
                            </a>
                          </li><!-- end notification -->
                          <?php }?>
                        </ul>
