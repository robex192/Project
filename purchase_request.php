...
<?php
		$query=mysqli_query($con,"select * from purchase_request natural join product natural join organization where branch_id='$branch' and purchase_status='pending' and date(request_date)>='$start' and date(request_date)<='$end' ")or die(mysqli_error($con));
...
?>                      
                ...
                <a class = "btn btn-primary btn-print" href = "home_cashier.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Reorder Page</a>
              </div><!-- /.box -->
            </div><!-- /.col (right) -->
