                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "select * from purchase_request natural join product natural join organization where branch_id='$branch' order by request_date")or die(mysqli_error());
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#updateordinance<?php echo $row['medicine_id']; ?>" data-target="#updateordinance<?php echo $row['medicine_id']; ?>" data-toggle="modal" class="btn btn-primary">Cancel</a>
