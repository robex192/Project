...
<html>
  <head>
    ...
    <title>Product Reorder | <?php include('../asset/includes/title.php');?></title>
...
<?php
		...
		$query=mysqli_query($con,"select * from product  natural join category where branch_id='$branch' and medicine_qty<=reorder order by medicine_name")or die(mysqli_error());
...
?>
            		...
            		<td><?php echo $row['reorder'];?></td>
                        <td><a href="#updateordinance<?php echo $row['medicine_id'];?>" data-target="#updateordinance<?php echo $row['medicine_id'];?>" data-toggle="modal" class="btn btn-primary">Request Purchase</a>
            ...
            <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['serial'];?>" readonly>  
				...
				<div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="medicine_id" value="<?php echo $row['medicine_id'];?>" required>  
					  <input type="text" class="form-control" id="name" name="medicine_name" value="<?php echo $row['medicine_name'];?>" readonly>  
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
					  <input type="text" class="form-control" id="price" name="prod_price" value="<?php echo $row['medicine_price'];?>" readonly>  
					</div>
				</div>
