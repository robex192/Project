  ...
  <body class="nav-md">
	...
	?>      
				  ...
				  <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-primary btn-print" href = "dashboard_admin.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>   
                    ...
                    <tbody>
							<?php
									...
									while($row=mysqli_fetch_array($query)){
										$total=$row['prod_price']*$row['medicine_qty'];
										$grand+=$total;
							?>
                      <tr>
