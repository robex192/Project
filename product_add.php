...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from product where medicine_name='$name' and branch_id='$branch'")or die(mysqli_error($con));
		...
		{	
			...
			mysqli_query($con,"INSERT INTO product(medicine_name,medicine_price,medicine_desc,medicine_pic,cat_id,reorder,user_id,branch_id,serial)
			VALUES('$name','$price','$desc','$pic','$category','$reorder','$name''$supplier','$branch','$serial')")or die(mysqli_error($con));
