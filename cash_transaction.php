...
<html>
  <head>
    ...
    <title>Home | <?php include('../asset/includes/title.php');?></title>
					...
					<div class=" col-md-2">
						<div class="form-group">
							...
							<div class="input-group">
							  <input type="number" class="form-control pull-right" id="date" name="medicine_qty" placeholder="Quantity" tabindex="2" value="1"  required>
							</div><!-- /.input group -->
						</div><!-- /.form group -->
					 </div>
					<div class="col-md-2">
...
?>
			  ...
			  <form class="form-horizontal" method="post" action="transaction_update.php" enctype='multipart/form-data'>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
					  <input type="text" class="form-control" id="price" name="medicine_qty" value="<?php echo $row['medicine_qty'];?>" required>  
					</div>
				</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="transaction_del.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="cid" value="<?php echo $cid;?>" required>   
          <input type="hidden" class="form-control" id="price" name="id" value="<?php echo $row['temp_trans_id'];?>" required>  
        <p>Are you sure you want to remove <?php echo $row['medicine_name'];?>?</p>
