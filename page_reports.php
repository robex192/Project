...
?>
  <body class="nav-md">
	...
	?>      
				  ...
				  <h5><b>Medicine Product stock values as of today, <?php echo date("M d, Y h:i a");?></b></h5>
				  ...
				  <a class = "btn btn-primary btn-print" href = "reports.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>   
							...
							<div class="row tile_count">
								...
								<?php 
									$query = mysqli_query($con,"select COUNT(*) as total_no_reorder from product where  branch_id ='$branch_id' AND medicine_qty <=reorder ") or die(mysqli_error($con));
